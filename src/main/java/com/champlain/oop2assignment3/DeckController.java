...
public class DeckController {
    ...
    /**
     * The deck of cards being managed by this controller (Singleton instance).
     */
    ...
    protected void onScoreButtonClick() {
        ...
        if (choice == null) {
            ...
            switch (choice) {
                case "Simple Count":
                    this.aScoreLabel.setText(String.valueOf((aHand.calculateScore(this.aDeck, "Simple Count"))));
                    break;
                case "Number Of Aces":
                    this.aScoreLabel.setText(String.valueOf((aHand.calculateScore(this.aDeck, "Number Of Aces"))));
                    break;
                default:
